...
data = pd.read_excel("E:/python/pasut/base_data/base_2018.xlsx") 
...
#membuat prediksi
t_prediksi = pd.date_range(start='2022-05-31 18:00:00', end='2022-06-30 17:00:00',freq='H')
tide = utide.reconstruct(t_prediksi, coef, verbose=False)
waterlevel = (tide.h) * 100
pasut = np.round((waterlevel + 130))
t_WIB = pd.date_range(start='2022-06-01 00:00:00', end='2022-06-30 23:00:00',freq='H')
data = {'waktu':t_prediksi,'waterlevel':waterlevel}
title = ['waktu','waterlevel']
df = pd.DataFrame(data, columns = title)
writer = pd.ExcelWriter('E:/python/pasut/Prakiraan Pasut BMKG/Juni2022.xlsx')
df.to_excel(writer,'Sheet1', header = True)
writer.save()
#plot hasil prediksi
# obs = pd.read_excel('E:/python/pasut/base_data/2022-05.xlsx')
